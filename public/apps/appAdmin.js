(function(){
    ...
    ifrm.setAttribute("src", "http://localhost:2121/loginAPI?apikey="+options.apikey);
    ifrm.setAttribute("width","100%");
    ifrm.setAttribute("frameborder","0");
    document.getElementById(options.element).appendChild(ifrm);
    resizer= document.createElement('script');
    resizer.setAttribute('src','http://localhost:2121/themes/default/assets/js/iframeResizer.min.js');
