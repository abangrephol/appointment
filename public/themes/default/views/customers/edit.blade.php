{{ Form::model($data, array('route' => array('customer.update', $data->id),'method'=>'PUT','class'=>'form form-horizontal')) }}
...
<div class="panel-body">
    ...
    <div class="form-group">
        {{ Form::label('old_password', 'Current Password', array('class' => 'col-sm-3 control-label')) }}
        <div class="col-sm-6">
            {{ Form::password('old_password', array('class'=>'form-control')) }}

            <label id="old_password_error" for="first" class="error" style="display: inline-block;"></label>
        </div>
    </div>
    <div class="form-group">
